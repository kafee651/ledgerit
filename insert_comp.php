...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body>
        ...
        <div id="wrap">
           ...
           <tr>
           <th width="94" rowspan="1" scope="row"><p align="left">Date<font color="#FF0000">*</font></p></th>
           <td width="108" height="4" align="right" valign="top"><font face='Verdana' size='2'>
           <select name="D">
           ...
           Day           </font></td>
           <td width="152" align="right" valign="top"><font face='Verdana' size='2'>
           <select name="M">
           ...
           <tr>
           <th width="94" scope="row"><p align="left">Description<font color="#FF0000">*</font></p></th>
           <td colspan="4"><font face='Verdana' size='2'>
           <input size="30" maxlength="100" name="Descript" type="text" id="name" /></font>
           </tr>
           
           <tr>
           <th width="94" scope="row"><p align="left">Quantity<font color="#FF0000">*</font></p></th>
           <td colspan="4"><font face='Verdana' size='2'>
...
$idate = $_POST['D'] + $_POST['M'] * 30 + $_POST['Y'] * 365;
$sql="INSERT INTO myexpenses (UserId, Date, Cat, Quantity, Price, Descript) VALUES ('$_SESSION[login_user]','$idate','$_POST[Cat]','$_POST[Quantity]','$_POST[Price]','$_POST[Descript]')";
