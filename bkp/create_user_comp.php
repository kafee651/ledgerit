...
<div id="wrap">
   ...
   <td width="100%"><form action="../new site/create_user_comp.php" method="POST" >
       <table width="430" height="415" border="0" align="left" >
           ...
           <tr>
           <td height="78" colspan="3" align="center" scope="row"><font color="FF0000"></font>
           <?php
...
$sql="INSERT INTO profile (Profile_name, UserID, Password) VALUES ('$_POST[uname]','$_POST[userid]','$_POST[Password]')";
